...
catgeory-sidebar sticky z-30 top-[5.75rem] left-0 shadow-md flex flex-col font-poppins hide-scrollbar bg-[rgb(60,0,107)] rounded-md text-white"
    >
      ...
      <div className="px-4 py-5  flex flex-col gap-5 border-b ">
        <div className=" flex gap-3 p-2 rounded-md items-center cursor-pointer bg-white text-black">
